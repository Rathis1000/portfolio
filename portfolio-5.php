    ...
    <div class="ajax-page-wrapper">
        <div class="ajax-page-nav">
            <div class="nav-item ajax-page-prev-next">
                <a class="ajax-page-load" href="portfolio-4.php"><i class="pe-7s-icon pe-7s-angle-left"></i></a>
                <a class="ajax-page-load" href="portfolio-1.php"><i class="pe-7s-icon pe-7s-angle-right"></i></a>
            </div>
        ...
        <div class="row">
            <div class="col-sm-7 col-md-7 portfolio-block">
                <div class="owl-carousel portfolio-page-carousel">
                    <div class="item">
                        <img src="Rathis/image-rathis/portfolio/full/7.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="Rathis/image-rathis/portfolio/full/8.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="Rathis/image-rathis/portfolio/full/9.jpg" alt="">
                    </div>
                </div>
